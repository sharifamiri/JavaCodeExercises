...
public class WrapperClass {
	...
	public static void main(String[] args) {
		...
		printByteValue((byte)10); //this one, we have to cast it, otherwise would print it as int
		
		byte b = 12;
		printByteValue(b); //this one prints without casting because it is byte already
	}
